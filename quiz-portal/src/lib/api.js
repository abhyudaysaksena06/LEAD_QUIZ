...
const FRIENDLY = {
  ...
  PUBLIC_EMAIL_NOT_ELIGIBLE: 'The open quiz is only for official @thapar.edu accounts. Sign in with your Thapar email.',
  PENDING_ROUND_CANNOT_OPEN: 'This is the holding round for students awaiting approval — it cannot be opened. Approve students in the Open quiz tab instead.',

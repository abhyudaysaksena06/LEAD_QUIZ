...
-- =====================================================================
HDR
for f in 01_schema.sql 02_student_api.sql 03_admin_api.sql 04_seed.sql 08_proctors.sql 09_rounds.sql 10_test_students.sql 12_question_bank.sql 13_paper_template.sql 15_admin_roster.sql 14_roster.sql 17_round_pools.sql 18_extend_time_fix.sql 19_activity_timer.sql 20_round_schedule.sql 21_no_round_cap.sql 22_no_id_storage.sql 23_public_quiz.sql 24_live_view.sql 25_scale.sql 26_exam_info.sql 27_thapar_only.sql 28_login_lockout.sql 29_open_quiz_students.sql 30_open_quiz_paper.sql 31_open_quiz_approval.sql; do
  printf '\n\n-- ##############################  %s  ##############################\n\n' "$f"; cat "$f"
done
cat <<'FTR'
